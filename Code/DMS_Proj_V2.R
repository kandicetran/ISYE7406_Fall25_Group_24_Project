...
high_set <- c(
  ...
  "ASSAULT","DRUG/NARCOTIC","PROSTITUTION","EXTORTION","BURGLARY","VEHICLE THEFT"
)
...
low_set <- c(
  ...
  "BAD CHECKS","LIQUOR LAWS","GAMBLING","NON-CRIMINAL","DISORDERLY CONDUCT",
  "BRIBERY","VANDALISM","SEX OFFENSES, NON FORCIBLE"
)
