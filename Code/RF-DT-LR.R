# This is the code used before the training and testing data sets were created with proportional data from each year
...
# crime = subset(crime, select = -c(Season)) # remove season from data as it is redundant due to month

high = c('Kidnapping', 'Sex Offenses, Forcible', 'Weapon Laws', 
         'Arson', 'Robbery', 'Assault', 'Burglary', 'Vehicle Theft',
         'Larceny/Theft')
#low = c('SUSPICIOUS OCC', 'FORGERY/COUNTERFEITING', 'OTHER OFFENSES',
#        'Drug/Narcotic', 
...
#        , 'SUICIDE', 'FRAUD', 'PORNOGRAPHY/OBSCENE MAT', 
...
# Convert DayOfWeek and PdDistrict to factors
...
# n1 = round(n/5); # number of observations randomly selected for testing data (20%)
# 
